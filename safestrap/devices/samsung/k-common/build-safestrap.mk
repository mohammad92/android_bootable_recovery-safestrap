BUILD_SAFESTRAP_CMD += && \
	...
	cp -fr $(SS_COMMON)/devices/samsung/k-common/res/* $(PRODUCT_OUT)/install-files/etc/safestrap/res/ && \
	cp -fr $(SS_COMMON)/devices/samsung/k-common/rootfs/* $(PRODUCT_OUT)/install-files/etc/safestrap/rootfs/ && \
	...
	cp -fr $(SS_COMMON)/devices/samsung/k-common/ss.config $(PRODUCT_OUT)/install-files/etc/safestrap/ss.config && \
